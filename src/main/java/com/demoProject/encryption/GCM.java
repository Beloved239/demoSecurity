package com.demoProject.encryption;
...
public class GCM {
    ...
    private static Cipher initCipher(int mode, SecretKey secretKey, byte[] iv) throws InvalidAlgorithmParameterException, InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException {
        Cipher cipher = Cipher.getInstance(CIPHER_ALGORITHM);
    ...
    private static byte[] getRandomNonce(int saltLength) {
        byte[] nonce = new byte[saltLength];
